return {
  ...
  config = function()
    ...
    local jdtls_config_dir = jdtls_root
      .. (vim.fn.has('win32') == 1 and '/config_win' or vim.fn.has('mac') == 1 and '/config_mac' or '/config_linux')
    ...
    if vim.bo.filetype == 'java' then start_or_attach() end

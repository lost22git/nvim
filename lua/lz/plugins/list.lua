...
return {{"EL-MASTOR/bufferlist.nvim", keys = {{"<Leader>b", "<Cmd>BufferList<CR>", desc = "[bufferlist] Open"}}, opts = {}}, {"ibhagwan/fzf-lua", cmd = "FzfLua", opts = {fzf_colors = true, winopts = {backdrop = vim.g.zz.backdrop, preview = {hidden = true}}}, config = _1_, keys = _2_}, {"stevearc/quicker.nvim", ft = "qf", keys = {{"<Leader>q", _6_, desc = "[quicker] Toggle qflist"}, {"<Leader>l", _7_, desc = "[quicker] Toggle loclist"}}, opts = {keys = {{">", _8_, desc = "[quicker] Expand context"}, {"<", _9_, desc = "[quicker] Collapse context"}}}}, {"mbbill/undotree", keys = {{"<Leader>u", "<CMD>UndotreeToggle<CR>", desc = "[undotree] Toggle"}}}, {"mikavilpas/yazi.nvim", cmd = "Yazi", opts = {}}}

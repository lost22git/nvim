...
return {{"nvim-treesitter/nvim-treesitter", build = _5_, dependencies = {"nvim-treesitter/nvim-treesitter-textobjects"}, event = {"BufReadPost", "BufNewFile"}, opts = {highlight = {enable = true, additional_vim_regex_highlighting = {"ruby"}, disable = {}}, indent = {enable = true, disable = {"ruby"}}, incremental_selection = {enable = true, disable = {"vim"}, keymaps = {init_selection = "<CR>", node_incremental = "<CR>", node_decremental = "<BS>"}}, autotag = {enable = true}, fold = {enable = true}, ensure_installed = {"bash", "lua", "regex", "vim", "vimdoc", "dockerfile", "http", "hurl", "just", "sql", "json", "toml", "xml", "yaml", "markdown", "markdown_inline", "css", "html", "javascript", "typescript", "clojure", "crystal", "gleam", "go", "gomod", "java", "nim", "rust", "zig"}, auto_install = false, sync_install = false}, config = _7_}, {"nvim-treesitter/nvim-treesitter-context", cmd = "TSContextEnable", opts = {}}}

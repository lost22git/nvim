...
return {{"echasnovski/mini.icons", config = _1_, lazy = false}, {"echasnovski/mini.files", opts = {}, keys = {{"<M-1>", _2_, desc = "[mini.files] Open"}, {"<M-2>", _3_, desc = "[mini.files] Open current directory"}}}, {"echasnovski/mini.move", opts = {}, lazy = false}, {"echasnovski/mini.statusline", opts = {use_icons = true, set_vim_settings = true}, lazy = false}, {"echasnovski/mini.cursorword", opts = {}, lazy = false}, {"echasnovski/mini.ai", dependencies = {{"echasnovski/mini.extra", opts = {}}}, config = _4_, lazy = false}, {"echasnovski/mini.surround", opts = {mappings = {add = "ms", delete = "md", find = "mf", find_left = "mF", highlight = "mh", replace = "mr", update_n_lines = "mn", suffix_last = "l", suffix_next = "n"}}, lazy = false}, {"echasnovski/mini.hipatterns", opts = {highlighters = {fixme = {pattern = "%f[%w]()FIXME()%f[%W]", group = "MiniHipatternsFixme"}, hack = {pattern = "%f[%w]()HACK()%f[%W]", group = "MiniHipatternsHack"}, todo = {pattern = "%f[%w]()TODO()%f[%W]", group = "MiniHipatternsTodo"}, note = {pattern = "%f[%w]()NOTE()%f[%W]", group = "MiniHipatternsNote"}, warn = {pattern = "%f[%w]()WARN()%f[%W]", group = "MiniHipatternsHack"}, warning = {pattern = "%f[%w]()WARNING()%f[%W]", group = "MiniHipatternsHack"}, err = {pattern = "%f[%w]()ERR()%f[%W]", group = "MiniHipatternsFixme"}, error = {pattern = "%f[%w]()ERROR()%f[%W]", group = "MiniHipatternsFixme"}}}, lazy = false}}

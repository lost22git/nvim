...
local function _2_()
  ...
  return vim.lsp.enable({"dockerls", "kulala_ls", "marksman", "nushell", "powershell_es", "html", "htmx", "svelte", "vtsls", "clojure_lsp", "crystalline", "dartls", "emmylua_ls", "fennel_ls", "gleam", "gradle_ls", "gopls", "julials", "koka", "kotlin_lsp", "ocamllsp", "ols", "racket_langserver", "roc_ls", "ruff", "rust_analyzer", "sourcekit", "v_analyzer"})
end

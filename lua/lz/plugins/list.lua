...
return {{"EL-MASTOR/bufferlist.nvim", keys = {{"<Leader>b", "<Cmd>BufferList<CR>", desc = "[bufferlist] Open"}}, opts = {}}, {"ibhagwan/fzf-lua", cmd = "FzfLua", opts = {fzf_colors = true, winopts = {backdrop = vim.g.zz.backdrop, preview = {hidden = true}}}, config = _1_, keys = _2_}, {"stevearc/quicker.nvim", ft = "qf", keys = {{"<Leader>q", _6_, desc = "[quicker] Toggle qflist"}, {"<Leader>l", _7_, desc = "[quicker] Toggle loclist"}}, opts = {keys = {{">", _8_, desc = "[quicker] Expand context"}, {"<", _9_, desc = "[quicker] Collapse context"}}}}, {"mikavilpas/yazi.nvim", cmd = "Yazi", opts = {}}, {"bassamsdata/namu.nvim", cmd = "Namu", opts = {global = {movement = {next = {"<M-j>", "<DOWN>"}, previous = {"<M-k>", "<UP>"}, close = {"<C-c>", "<Esc>"}}, multiselect = {enabled = true, selected_icon = "\226\156\147", keymaps = {toggle = "<Tab>", untoggle = "<S-Tab>", select_all = "<M-a>", clear_all = "<M-x>"}}, custom_keymaps = {yank = {keys = {"<M-y>"}, desc = "Yank symbol text"}, delete = {keys = {"M-d"}, desc = "Delete symbol text"}}}, namu_symbols = {enable = true, options = {}}, ui_select = {enable = false}}}}

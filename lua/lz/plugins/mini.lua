...
return {{"nvim-mini/mini.icons", config = _1_, lazy = false}, {"nvim-mini/mini.cursorword", opts = {}, lazy = false}, {"nvim-mini/mini.move", opts = {}, lazy = false}, {"nvim-mini/mini.ai", dependencies = {{"nvim-mini/mini.extra", opts = {}}}, config = _2_, lazy = false}, {"nvim-mini/mini.surround", opts = {mappings = {add = "ss"}}, lazy = false}, {"nvim-mini/mini.hues", init = _5_, enabled = false, lazy = false}, {"nvim-mini/mini.bufremove", opts = {}, lazy = false}, {"nvim-mini/mini.files", opts = {windows = {preview = true}}, keys = {{"<M-1>", _6_, desc = "[mini.files] Open"}, {"<M-2>", _7_, desc = "[mini.files] Open current directory"}}, lazy = false}}

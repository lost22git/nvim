...
return {{"ibhagwan/fzf-lua", cmd = "FzfLua", opts = {fzf_colors = true, winopts = {backdrop = vim.g.zz.backdrop, preview = {hidden = true}}}, config = _1_, keys = _3_}, {"mikavilpas/yazi.nvim", cmd = "Yazi", opts = {}}, {"mbbill/undotree", keys = {{"<Leader>u", "<CMD>UndotreeToggle<CR>", desc = "[undotree] Toggle"}}}, {"stevearc/aerial.nvim", opts = {}, keys = {{"<Leader>O", "<Cmd>AerialToggle<Cr>", desc = "[aerial] toggle"}}}, {"stevearc/quicker.nvim", ft = "qf", keys = {{"<Leader>q", _7_, desc = "[quicker] Toggle qflist"}, {"<Leader>l", _8_, desc = "[quicker] Toggle loclist"}}, opts = {keys = {{">", _9_, desc = "[quicker] Expand context"}, {"<", _10_, desc = "[quicker] Collapse context"}}}}, {"bassamsdata/namu.nvim", cmd = "Namu", opts = {global = {movement = {next = {"<M-j>", "<DOWN>"}, previous = {"<M-k>", "<UP>"}, close = {"<C-c>", "<Esc>"}}, multiselect = {enabled = true, selected_icon = "\226\156\147", keymaps = {toggle = "<Tab>", untoggle = "<S-Tab>", select_all = "<M-a>", clear_all = "<M-x>"}}, custom_keymaps = {yank = {keys = {"<M-y>"}, desc = "Yank symbol text"}, delete = {keys = {"M-d"}, desc = "Delete symbol text"}}}, namu_symbols = {enable = true, options = {}}, ui_select = {enable = false}}, keys = _11_}}

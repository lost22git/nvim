...
return {{"stevearc/aerial.nvim", opts = {}, keys = {{"<Leader>O", "<Cmd>AerialToggle<Cr>", desc = "[aerial] toggle"}}}, {"stevearc/quicker.nvim", ft = "qf", keys = {{"<Leader>q", _1_, desc = "[quicker] Toggle qflist"}, {"<Leader>l", _2_, desc = "[quicker] Toggle loclist"}}, opts = {keys = {{">", _3_, desc = "[quicker] Expand context"}, {"<", _4_, desc = "[quicker] Collapse context"}}}}, {"mikavilpas/yazi.nvim", cmd = "Yazi", opts = {}}, {"ibhagwan/fzf-lua", opts = {fzf_colors = true, winopts = {backdrop = vim.g.zz.backdrop, preview = {hidden = true}}}, config = _5_, keys = _7_, lazy = false}}

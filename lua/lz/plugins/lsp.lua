...
local function _2_()
  ...
  return vim.lsp.enable({"dockerls", "kulala_ls", "marksman", "nushell", "powershell_es", "clojure_lsp", "crystalline", "dartls", "emmylua_ls", "fennel_ls", "gleam", "gradle_ls", "gopls", "julials", "koka", "kotlin_lsp", "ocamllsp", "ols", "racket_langserver", "roc_ls", "rust_analyzer", "sourcekit", "ty", "v_analyzer", "html", "htmx", "svelte"})
end

...
do
  ...
  local function _12_(...)
    local tbl_21_ = {}
    for _, _13_ in ipairs({{"<A", "inner_start"}, {">A", "inner_end"}}) do
      local k = _13_[1]
      local v = _13_[2]
      local k_22_, v_23_
      local function _14_()
      ...
      k_22_, v_23_ = k, {_14_, ("Wrap form " .. v)}
      if ((k_22_ ~= nil) and (v_23_ ~= nil)) then
        tbl_21_[k_22_] = v_23_
      else
      end
  ...
  _7_ = vim.tbl_extend("error", _8_, _12_(...))
end
local _16_
do

...
local function _3_(_, opts)
  ...
  vim.api.nvim_create_autocmd("FileType", {pattern = ftypes, callback = _4_})
...
return {{"Olical/conjure", cmd = "ConjureConnect", ft = {"lua", "fennel", "clojure", "janet", "racket"}, init = _1_}, {"pappasam/nvim-repl", cmd = "Repl", opts = {filetype_commands = {crystal = {cmd = "crystal i"}, elixir = {cmd = "iex"}, java = {cmd = "jshell"}, lfe = {cmd = "lfe"}, nim = {cmd = "inim"}, raku = {cmd = "rlwrap raku"}, swift = {cmd = "swift repl"}}}, config = _3_}}

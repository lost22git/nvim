...
local function _7_()
  return vim.cmd.colorscheme("miniwinter")
end
return {{"nvim-mini/mini.icons", config = _1_, lazy = false}, {"nvim-mini/mini.cursorword", opts = {}, lazy = false}, {"nvim-mini/mini.files", opts = {windows = {preview = true}}, keys = {{"<M-1>", _2_, desc = "[mini.files] Open"}, {"<M-2>", _3_, desc = "[mini.files] Open current directory"}}, lazy = false}, {"nvim-mini/mini.move", opts = {}, lazy = false}, {"nvim-mini/mini.ai", dependencies = {{"nvim-mini/mini.extra", opts = {}}}, config = _4_, lazy = false}, {"nvim-mini/mini.surround", opts = {mappings = {add = "ss"}}, lazy = false}, {"nvim-mini/mini.hipatterns", opts = {highlighters = {fixme = {pattern = "%f[%w]()FIXME()%f[%W]", group = "MiniHipatternsFixme"}, hack = {pattern = "%f[%w]()HACK()%f[%W]", group = "MiniHipatternsHack"}, todo = {pattern = "%f[%w]()TODO()%f[%W]", group = "MiniHipatternsTodo"}, note = {pattern = "%f[%w]()NOTE()%f[%W]", group = "MiniHipatternsNote"}, warn = {pattern = "%f[%w]()WARNI?N?G?()%f[%W]", group = "MiniHipatternsHack"}, error = {pattern = "%f[%w]()ERRO?R?()%f[%W]", group = "MiniHipatternsFixme"}}}, lazy = false}, {"nvim-mini/mini.hues", init = _7_, lazy = false}}

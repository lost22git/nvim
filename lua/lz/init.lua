...
return lazy.setup("lz.plugins", {defaults = {lazy = true}, lockfile = (vim.fn.stdpath("config") .. "/lazy-lock.json"), git = {log = {"--since=3 days ago"}, timeout = 120, url_format = "https://github.com/%s.git"}, ui = {size = {width = 0.8, height = 0.8}, border = vim.o.winborder, backdrop = (vim.g.zz.backdrop or 100)}, performance = {reset_packpath = true, rtp = {disabled_plugins = {"gzip", "matchit", "matchparen", "netrwPlugin", "tarPlugin", "tohtml", "tutor", "zipPlugin", "spellfile"}}}})
